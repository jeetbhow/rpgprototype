...
public partial class OverworldParty : Node2D
{
    ...
    [Export] public Array<OverworldCharacter> PartyMembers { get; set; }
    [Export] public OverworldCharacter PartyLeader { get; set; }
    ...
    {
        foreach (OverworldCharacter member in PartyMembers)
        {
    ...
    private void FollowLeader(OverworldCharacter member)
    {
    ...
    private static void InitCollisions(OverworldCharacter member, CollisionObject.CollisionLayer type)
    {
        switch (type)
        {
    ...
    private void OnPartyMemberAdded(OverworldCharacter newMember)
    {
